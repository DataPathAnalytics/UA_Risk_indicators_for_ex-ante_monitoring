...
@Data
@Entity
@Table(name = "eligibility_document",
        indexes = {
                @Index(columnList = "tender_id", name = "eligibility_document_tender_id_idx"),
                @Index(columnList = "bid_id", name = "eligibility_document_bid_id_idx")
        })
