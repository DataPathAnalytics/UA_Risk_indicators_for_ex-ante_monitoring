...
@Component
@Slf4j
public class Risk_2_18_1_Processor extends BaseExtractor {
    ...
    public List<TenderIndicator> process(Indicator indicator, List<Tender> tenders, Map<String, RequestDTO> requestMap) {
        ...
        tenders.forEach(tender -> {
            ...
            if (STATUSES.contains(tender.getStatus())) {
    ...
    private Map<String, MonitoringEntity> getMonitoringMap(List<String> tenderOuterIds) {
        Map<String, MonitoringEntity> monitoringMap = new HashMap<>();
        monitoringRepository
                .findAllByTenderIdIn(tenderOuterIds)
                .forEach(monitoring -> monitoringMap.put(monitoring.getTenderId(), monitoring));
