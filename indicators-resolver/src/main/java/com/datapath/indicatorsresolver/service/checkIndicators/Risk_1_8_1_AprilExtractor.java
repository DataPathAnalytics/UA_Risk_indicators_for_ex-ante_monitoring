...
@Service
@Slf4j
public class Risk_1_8_1_AprilExtractor extends BaseExtractor {

    private final String INDICATOR_CODE = "RISK-1-8-1";

    private final Double PERCENTAGE_DIFF_LIMIT = 0.500001;

    private boolean indicatorsResolverAvailable;

    public Risk_1_8_1_AprilExtractor() {
    ...
    private void checkIndicator(Indicator indicator, ZonedDateTime dateTime) {
        ...
        while (true) {
            ...
            List<String> tenders = tenderRepository.getIndicator1_8_1TenderData(
                    dateTime,
