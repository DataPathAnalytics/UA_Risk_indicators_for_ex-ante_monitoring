...
@Service
@Slf4j
public class Risk_2_6_AprilExtractor extends BaseExtractor {

    private final String INDICATOR_CODE = "RISK-2-6";
    private boolean indicatorsResolverAvailable;
    private NearThresholdRepository nearThresholdRepository;

    public Risk_2_6_AprilExtractor(NearThresholdRepository nearThresholdRepository) {
