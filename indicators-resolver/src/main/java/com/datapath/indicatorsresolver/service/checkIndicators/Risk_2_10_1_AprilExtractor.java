...
@Service
@Slf4j
public class Risk_2_10_1_AprilExtractor extends BaseExtractor {

    private final String INDICATOR_CODE = "RISK-2-10-1";
    private boolean indicatorsResolverAvailable;

    public Risk_2_10_1_AprilExtractor() {
    ...
    @Async
    @Scheduled(cron = "${risk-2-10-1.cron}")
    ...
    private void checkIndicator(Indicator indicator, ZonedDateTime dateTime) {
        ...
        while (true) {
            ...
            List<String> tenders = tenderRepository.getIndicator_2_10_1TenderData(
                    dateTime,
