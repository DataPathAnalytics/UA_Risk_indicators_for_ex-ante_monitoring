...
@Service
@Slf4j
public class Risk_2_7_AprilExtractor extends BaseExtractor {

    private final String INDICATOR_CODE = "RISK-2-7";
    private boolean indicatorsResolverAvailable;
    private NearThresholdOneSupplierRepository nearThresholdOneSupplierRepository;

    public Risk_2_7_AprilExtractor(NearThresholdOneSupplierRepository nearThresholdOneSupplierRepository) {
    ...
    @Async
    @Scheduled(cron = "${risk2_7_april.cron}")
