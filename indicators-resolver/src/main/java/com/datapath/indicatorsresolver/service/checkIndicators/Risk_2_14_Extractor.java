...
@Service
@Slf4j
public class Risk_2_14_Extractor extends BaseExtractor {

    /*
    Недопуск до оцінки більше ніж 2-х учасників при проведенні процедури закупівлі робіт (понад "європейські пороги")
     */

    private final String INDICATOR_CODE = "RISK2-14";
    private boolean indicatorsResolverAvailable;

    public Risk_2_14_Extractor() {
    ...
    private void checkRisk2_14Indicator(Indicator indicator, ZonedDateTime dateTime) {
        int size = 100;
        int page = 0;
        while (true) {
