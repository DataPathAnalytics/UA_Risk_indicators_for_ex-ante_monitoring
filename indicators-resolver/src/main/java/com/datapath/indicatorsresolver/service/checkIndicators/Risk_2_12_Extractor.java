...
@Service
@Slf4j
public class Risk_2_12_Extractor extends BaseExtractor {

    /*
    Велика кількість змін у контракті
     */

    private final String INDICATOR_CODE = "RISK2-12";
    private boolean indicatorsResolverAvailable;

    public Risk_2_12_Extractor() {
    ...
    private void checkRisk2_12Indicator(Indicator indicator, ZonedDateTime dateTime) {
        ...
        while (true) {
            ...
            List<Object[]> activeChangesByTenderIds = contractChangeRepository.getActiveChangesByTenderIds(contracts.stream().collect(Collectors.joining(",")));
