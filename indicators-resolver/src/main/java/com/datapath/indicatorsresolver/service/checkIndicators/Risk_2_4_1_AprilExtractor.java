...
@Service
@Slf4j
public class Risk_2_4_1_AprilExtractor extends BaseExtractor {

    private final String INDICATOR_CODE = "RISK-2-4-1";
    private boolean indicatorsResolverAvailable;

    public Risk_2_4_1_AprilExtractor() {
    ...
    private void checkIndicator(Indicator indicator, ZonedDateTime dateTime) {
        ...
        while (true) {
            ...
            List<String> tenders = tenderRepository.getIndicator2_4_1TenderData(
                    dateTime,
