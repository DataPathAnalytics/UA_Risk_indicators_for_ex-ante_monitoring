...
@Service
@Slf4j
public class Risk_2_5_AprilExtractor extends BaseExtractor {

    private final String INDICATOR_CODE = "RISK-2-5";
    private boolean indicatorsResolverAvailable;
    private NearThresholdRepository nearThresholdRepository;

    public Risk_2_5_AprilExtractor(NearThresholdRepository nearThresholdRepository) {
    ...
    @Async
    @Scheduled(cron = "${risk2_5_april.cron}")
