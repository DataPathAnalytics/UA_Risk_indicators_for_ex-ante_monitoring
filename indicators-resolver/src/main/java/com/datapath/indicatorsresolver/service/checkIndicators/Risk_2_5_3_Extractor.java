...
@Service
@Slf4j
public class Risk_2_5_3_Extractor extends BaseExtractor {
    ...
    */
    ...
    public Risk_2_5_3_Extractor(NearThresholdOneSupplierRepository nearThresholdOneSupplierRepository) {
    ...
    private void checkRisk2_5_3Indicator(Indicator indicator, ZonedDateTime dateTime) {
        int size = 100;
        int page = 0;
        while (true) {

            List<Object[]> tenders = tenderRepository.findGoodsServicesProcuringEntityKindAndSupplierAmount(
                    dateTime,
