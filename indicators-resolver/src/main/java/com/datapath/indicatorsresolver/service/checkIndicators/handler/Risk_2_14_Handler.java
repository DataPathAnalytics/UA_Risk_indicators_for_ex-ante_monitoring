...
import com.datapath.indicatorsresolver.service.checkIndicators.processors.Risk_2_14_Processor;
...
@Service
@Slf4j
public class Risk_2_14_Handler extends BaseExtractor {

    private final String INDICATOR_CODE = "RISK-2-14";
    private boolean indicatorAvailable;

    private Risk_2_14_Processor processor;

    public Risk_2_14_Handler(Risk_2_14_Processor processor) {
