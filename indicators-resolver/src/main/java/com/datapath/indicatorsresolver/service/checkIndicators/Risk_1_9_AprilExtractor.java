...
@Service
@Slf4j
public class Risk_1_9_AprilExtractor extends BaseExtractor {

    private final String INDICATOR_CODE = "RISK-1-9";
    ...
    public Risk_1_9_AprilExtractor() {
    ...
    private void checkIndicator(Indicator indicator, ZonedDateTime dateTime) {
        ...
        while (true) {
            ...
            List<Object[]> tenders = tenderRepository.getIndicator1_9TenderData(
                    dateTime,
