...
@Service
@Slf4j
public class Risk_2_8_1_AprilExtractor extends BaseExtractor {

    private final String INDICATOR_CODE = "RISK-2-8-1";
    private boolean indicatorsResolverAvailable;
    private NearThresholdOneSupplierRepository nearThresholdOneSupplierRepository;

    public Risk_2_8_1_AprilExtractor(NearThresholdOneSupplierRepository nearThresholdOneSupplierRepository) {
