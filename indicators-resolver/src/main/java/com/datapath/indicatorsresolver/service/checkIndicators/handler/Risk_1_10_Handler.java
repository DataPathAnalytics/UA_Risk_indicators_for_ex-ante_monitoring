...
import com.datapath.indicatorsresolver.service.checkIndicators.processors.Risk_1_10_Processor;
...
@Service
@Slf4j
public class Risk_1_10_Handler extends BaseExtractor {

    private final String INDICATOR_CODE = "RISK-1-10";
    private boolean indicatorAvailable;

    private Risk_1_10_Processor processor;

    public Risk_1_10_Handler(Risk_1_10_Processor processor) {
