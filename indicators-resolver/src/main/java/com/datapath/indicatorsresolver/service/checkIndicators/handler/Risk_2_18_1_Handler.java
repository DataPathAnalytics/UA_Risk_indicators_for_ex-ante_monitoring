...
import com.datapath.indicatorsresolver.service.checkIndicators.processors.Risk_2_18_1_Processor;
...
@Slf4j
@Component
public class Risk_2_18_1_Handler extends BaseExtractor {

    private static final String INDICATOR_CODE = "RISK-2-18-1";
    private boolean indicatorAvailable;

    private Risk_2_18_1_Processor processor;
    private RequestsService requestsService;

    public Risk_2_18_1_Handler(Risk_2_18_1_Processor processor, RequestsService requestsService) {
    ...
    @Async
    @Scheduled(cron = "${risk-2-18-1.cron}")
    public void handle() {
