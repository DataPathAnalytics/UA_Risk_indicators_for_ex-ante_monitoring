...
@Service
@Slf4j
public class Risk_1_2_2_Extractor extends BaseExtractor {

    /*
    Закупівля робіт кваліфікується як відкриті торги (EU), але замовником обрана інша процедура
    */
    private final String INDICATOR_CODE = "RISK1-2_2";
    private final Integer EUR_LIMIT = 5150000;
    private boolean indicatorsResolverAvailable;

    public Risk_1_2_2_Extractor() {
    ...
    private void checkRisk_1_2_2_Indicator(Indicator indicator, ZonedDateTime dateTime) {
        int size = 100;
        int page = 0;
        while (true) {

            List<Object[]> tendersInfo = tenderRepository.findWorkTenderIdCurrencyAmountByProcedureStatusAndProcedureType(
                    dateTime,
